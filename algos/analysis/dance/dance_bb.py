...
def dance_bb(score_arr: Sequence[Number]) -> Tuple[Number, List[Number]]:
    ...
    for i in range(len(score_arr)):
        path_curr = []
        score, path = dance_bb_rec(unit_score, score_arr, score_max,
                                score_curr, currtime,
...
def dance_bb_rec(unit_score: Sequence[Number], score_arr: Sequence[Number],
